...
$dadosboleto["sacado"] = $_SESSION['nome_completo'];
$dadosboleto["endereco1"] = $_SESSION['endereco'].", ".$_SESSION['numero'];
$dadosboleto["endereco2"] = $_SESSION['cidade']." - ".$_SESSION['estado']." - ".$_SESSION['cep']." - ".$_SESSION['complemento'] ;

// INFORMACOES PARA O CLIENTE
$dadosboleto["demonstrativo1"] = "Pagamento de Compra na plataforma WiseMind";
$dadosboleto["demonstrativo2"] = "Mensalidade referente a assinatura do plano na plataforma WiseMind - R$ ".$_SESSION['valor']."<br>Taxa bancaria - R$ ".number_format($taxa_boleto, 2, ',', '');
$dadosboleto["demonstrativo3"] = "BoletoPhp - http://www.boletophp.com.br";

// INSTRU��ES PARA O CAIXA
$dadosboleto["instrucoes1"] = "- Sr. Caixa, cobrar multa de 2% após o vencimento";
$dadosboleto["instrucoes2"] = "- Receber até 10 dias após o vencimento";
$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: esportsgrouptcc@gmail.com";
$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto BoletoPhp - www.boletophp.com.br";

// DADOS OPCIONAIS DE ACORDO COM O BANCO OU CLIENTE
$dadosboleto["quantidade"] = "1";
$dadosboleto["valor_unitario"] = $_SESSION['valor'];
...
// SEUS DADOS
$dadosboleto["identificacao"] = "WiseMind - Educacional";
$dadosboleto["cpf_cnpj"] = "71.179.179/0001-71";
$dadosboleto["endereco"] = "Av. Prefeito João Pires Filho, 57 - Treze de Maio.";
$dadosboleto["cidade_uf"] = "Santa Isabel - São Paulo, 07500-000.";
$dadosboleto["cedente"] = "WiseMind - Educacional";
