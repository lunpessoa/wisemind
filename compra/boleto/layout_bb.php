	...
	<STYLE>
		...
		print {
			...
			* {
			...
			#instr_header {
				background: url('imagens/logo.JPEG') no-repeat top left;
				padding-left: 160px;
				height: 65px;
			}
...
<body>
	...
	<div id="container">
		...
		<div id="instr_header">
			<h1><?php echo $dadosboleto["identificacao"]; ?>
				<?php echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?></h1>
 ...
 -->
		...
		<div id="boleto">
			...
			<table class="header" border=0 cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td width=50><IMG SRC="imgs/bb.png"></td>
						<td width=50>
			...
			<table class="header" border=0 cellspacing="0" cellpadding="0">
				<tbody>
					<tr>
						<td width=150><IMG SRC="imgs/bb.png"></td>
						<td width=50>
							<div class="field_cod_banco"><?php echo $dadosboleto["codigo_banco_com_dv"]?></div>
						</td>
						<td class="linha_digitavel"><?php echo $dadosboleto["linha_digitavel"]?></td>
			...
			<table class="line" cellspacing="0" cellPadding="0">
				<tbody>
					...
					<tr class="campos">
						...
						<td class="carteira"><?php echo $dadosboleto["carteira"]?>
				...
				<TBODY>
					<TR>
						<TD width=666 align=right>
							<font style="font-size: 10px;">Autenticação mecânica - Ficha de
								Compensação</font>
						</TD>
					</tr>
				</tbody>
