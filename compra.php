<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="style/cssscompra.css" />
...
<body id="body">
	...
	<font face="century gothic" color="#fff">
		<section id="vantagens"><br><br>
			<center><h1>Vantagens do Plano Wiser</h1></center>
		...
		<section id="formulario">
			...
			<section class="row justify-content-center mb-5">
				<section id="segundo">
				<h4><b><font color="#003f6c">PLANO WISER</font></b></h4> 
				<b>Pagamento R$39,99</b><br><br>
				Para concluir o pagamento, precisamos dos seguintes dados pessoais para efetuarmos a geração do boleto
					...
					<form>
						...
						<section class="form-group">
							...
							<input type="text" class="form-control" id="inputAddress2" placeholder="Apartamento, Casa, Estudio...">
						</section>
						<section class="form-row">
							<section class="form-group col-md-6">
