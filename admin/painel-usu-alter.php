<?php
	...
	if($con['id_privilegio']==1){
		$sql2=('select * from estudantes where id_estudante = '.$id_user.';');
		$resul2=mysqli_query($conexao, $sql2);
		$est=mysqli_fetch_array($resul2);
	}else if($con['id_privilegio']==2){
		$sql2=('select * from profissional where id_profissional = '.$id_user.';');
		$resul2=mysqli_query($conexao, $sql2);
		$est=mysqli_fetch_array($resul2);
	}
?>
	...
	<div class="modal fade" id="modalExemplo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="alterar-admin.php" method="POST" enctype="multipart/form-data">
			...
			<div class="col-7 offset-4">
				<div class="card border border-0 bg-transparent">
					...
					<div class="modal fade" id="modalProfissao" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form action="alterar-admin.php" method="POST" class="container was-validated"
									novalidate="" autocomplete="off">
									<div class="modal-body">
					...
					<div class="card-body border-0 p-5 d-none" id="informacoes-alter-8">
						<?php
						$sql_pesq=('select * from especializacao where id_prof = "'.$id_user.'";');
					...
					?>
						<form name="cad" action="alterar-admin.php" method="POST" class="container was-validated"
							...
							<table class="table table-borderless text-light w-50">
								...
								<tbody>
									<?php
									$sqlmostrar=('select * from especializacao where id_prof = "'.$id_user.'";');
						...
						<div class="row p-2">
							...
							<div class="col-5 align-items-center d-flex">
								<span class="h5 text-white align-middle">
									<?php
										$sql_register= ('select ultimo_login from date_login where id_usu = '.$id_user.';');
...
<?php
	...
	if($con['id_privilegio']==3){
		$_SESSION["adminchange"]=true;
