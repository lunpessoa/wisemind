...
.form-control:focus {
  ...
  border-color: #0082ee;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(0, 60, 110, 0.25);
}
...
.btn-primary:focus, .btn-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(38, 89, 132, 0.5);
}
...
.btn-warning:focus, .btn-warning.focus {
  box-shadow: 0 0 0 0.2rem rgba(222, 182, 41, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(0, 60, 110, 0.5);
}
...
.btn-outline-warning:focus, .btn-outline-warning.focus {
  box-shadow: 0 0 0 0.2rem rgba(255, 207, 41, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(0, 60, 110, 0.25);
}
